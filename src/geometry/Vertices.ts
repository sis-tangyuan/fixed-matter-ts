...
export default class Vertices {
     ...
     * @param scalar 
     */
    public static translate(vertices: Vertex[], vector: Vector, scalar: Decimal = new Decimal(1)): Vertex[] {
     ...
     * @returns 
     */
    public static rotate(vertices: Vertex[], angle: Decimal, point: Vector): Vertex[] {
     ...
     * @returns 
     */
    public static scale(vertices: Vertex[], scaleX: Decimal, scaleY: Decimal, point?: Vector): Vertex[] {
    ...
    public static hull(vertices: Vertex[]): Vertex[] {
        ...
        for (i = 0; i < vertices.length; i++) {
            ...
            while(lower.length > 2
                && Vector.cross33(lower[lower.length-2].vector, lower[lower.length - 1].vector, vertex.vector).lte(zero)) {
                lower.pop()
            }
        ...
        for (i = vertices.length-1; i >= 0 ; i--) {
            ...
            while(upper.length > 2
                && Vector.cross33(upper[upper.length-2].vector, upper[upper.length - 1].vector, vertex.vector).lte(zero)) {
                    upper.pop()
            }
